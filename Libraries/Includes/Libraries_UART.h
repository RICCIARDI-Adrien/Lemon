 ...
 */
#ifndef H_LIBRARIES_UART_H
#define H_LIBRARIES_UART_H

//-------------------------------------------------------------------------------------------------
// Constants
//-------------------------------------------------------------------------------------------------
/** Disable parity when initializing UART. */
#define LIBRARIES_UART_PARITY_NONE 0x00
/** Set odd parity (parity must be enabled to use this flag). */
#define LIBRARIES_UART_PARITY_ODD 0x08
/** Set even parity (parity must be enabled to use this flag). */
#define LIBRARIES_UART_PARITY_EVEN 0x18

/** Baud rate at 1200 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_1200 96
/** Baud rate at 2400 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_2400 48
/** Baud rate at 4800 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_4800 24
/** Baud rate at 9600 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_9600 12
/** Baud rate at 19200 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_19200 6
/** Baud rate at 38400 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_38400 3
/** Baud rate at 57600 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_57600 2
/** Baud rate at 115200 bit/s. */
#define LIBRARIES_UART_BAUD_RATE_115200 1
 ...
 * @param Frame_Format The format of the RS-232 frame. Use a constant from LIBRARIES_UART_PARITY_NONE, LIBRARIES_UART_PARITY_EVEN or LIBRARIES_UART_PARITY_ODD to configure serial port.
 * @param Data_Rate_Bauds The data rate from a LIBRARIES_UART_BAUD_RATE_XXX constant.
