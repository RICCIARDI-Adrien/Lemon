...
// French strings
	...
	#define STRING_ERROR_NETWORK_SOCKET_INITIALIZATION "Erreur lors de l'initialisation de la socket r\202seau (est-ce que la machine de destination est op\202rationnelle ?).\n"
#endif
