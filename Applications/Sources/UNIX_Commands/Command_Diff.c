...
int CommandMainDiff(int argc, char *argv[])
{
	...
	if (FileOpen(String_File_1_Name, FILE_OPENING_MODE_READ, &File_Descriptor_1) != ERROR_CODE_NO_ERROR)
	{
	...
	if (FileOpen(String_File_2_Name, FILE_OPENING_MODE_READ, &File_Descriptor_2) != ERROR_CODE_NO_ERROR)
	{
		ScreenWriteString(STRING_COMMAND_DIFF_FILE_CANT_BE_OPENED_1);
