...
// French strings
	...
	#define STRING_BAD_RESULT_1 "Erreur, le r\202sultat \202tait "
	#define STRING_BAD_RESULT_2 ".\n"
	#define STRING_CORRECT_ANSWERS_COUNT_1 "Vous avez r\202solu "
	#define STRING_CORRECT_ANSWERS_COUNT_2 " calcul(s).\n"
#endif
