...
#define CONFIGURATION_COPY_BUFFER_MAXIMUM_SIZE (SCREEN_ROWS_COUNT * SCREEN_COLUMNS_COUNT * 10) // Up to 10 full pages
...
#define CONFIGURATION_DISPLAY_ROWS_COUNT SCREEN_ROWS_COUNT

/** The text foreground color. */
#define CONFIGURATION_TEXT_FOREGROUND_COLOR SCREEN_COLOR_BLUE
/** The text background color. */
#define CONFIGURATION_TEXT_BACKGROUND_COLOR SCREEN_COLOR_WHITE
/** The cursor background color. */
#define CONFIGURATION_CURSOR_BACKGROUND_COLOR SCREEN_COLOR_LIGHT_GREEN
