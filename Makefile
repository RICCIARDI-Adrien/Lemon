...
qemu-run: QEMU_Hard_Disk.img
	...
	qemu-system-i386 -m 16M -device e1000 -name Lemon -drive file=QEMU_Hard_Disk.img,media=disk,format=raw -serial unix:/tmp/Lemon_Serial_Port_Socket,server=on,wait=off $(QEMU_OPTIONS)
