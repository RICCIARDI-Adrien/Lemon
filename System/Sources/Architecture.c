...
void ArchitectureSwitchToUserSpace(void)
{
	...
	(
		...
		: // No output parameters
		: "i" ((ARCHITECTURE_MEMORY_PROTECTION_SEGMENT_INDEX_USER_DATA << 3) | 3), "i" (KERNEL_USER_SPACE_SIZE), "i" ((ARCHITECTURE_MEMORY_PROTECTION_SEGMENT_INDEX_USER_CODE << 3) | 3), "i" (KERNEL_PROGRAM_ENTRY_POINT), "i" ((ARCHITECTURE_MEMORY_PROTECTION_SEGMENT_INDEX_USER_DATA << 3) | 3)
		: "eax"
	);
}
